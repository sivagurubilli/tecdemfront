...
function Amazon() {
  let Outline = [
    ...
    {
      id: 1,
      title: "Introduction to Database Services",
      link: "/course-video",
    },
    {
      id: 1,
      title: "Introduction to Management Services",
      link: "/course-video",
    },
  ];
  return (
                          ...
                          <div class="accordion-body">
                            <div class="material-list">
                              <ul>
                                <li>
                                  <a href="/">
                                    <i class="bx bx-file"></i>Creating a NodeJs
                                    Server and Custom AMI
                                  </a>
                                </li>
                                <li>
                                  <a href="/">
                                ...
                                <li>
                                  <a href="/">
                                    <i class="bx bx-file"></i>Advanced -
                                    DynamoDB
                                  </a>
                                </li>
                                <li>
                                  <a href="/">
                                    <i class="bx bx-file"></i>VPC Networking
                                  </a>
                                </li>
                                <li>
                                  <a href="/">
                                    <i class="bx bx-file"></i>Hands On -
                                    OpsWorks
                                  </a>
                                </li>
                                <li>
                                  <a href="/">
                                    <i class="bx bx-file"></i>CodePipeline - CI
                                    CD{" "}
                                  </a>
                                </li>
                                <li>
                                ...
                                <li>
                                  <a href="/">
                                    <i class="bx bx-file"></i>AWS Big Data
                                    Solutions
                                  </a>
                                </li>
                                <li>
                                  <a href="/">
                                    <i class="bx bx-file"></i>Amazon Kinesis
                                  </a>
                                </li>
                                <li>
                                  <a href="/">
                                    <i class="bx bx-file"></i>AWS Serverless
                                    Platform
                                  </a>
                                </li>
                              </ul>
