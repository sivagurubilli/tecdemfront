...
const IFlowFullScreen = ({ setVisibleCards, visibleCards }) => {
  ...
  // console.log("[IFLowFullScreen: ]",flowVideos)
  // const [flowVideos, setFlowVideos] = useState({
  //   iFlowItems: [],
  //   buckListItems: [],
  // });
  ...
  const handleDrop = (event) => {
    try {
      // event.preventDefault();
      console.log('iFlowFullScreen:',event)
      ...
      for (const item of data.buckListItems) {
        ...
        if (formattedItem) {
          ...
          if(response.success){
           ...
           toastSuccess(`${data.buckListItems?.length} items added to BucketList`)
            return
          }

        else{
          toastError('Failed to add items in BucketList');
        }
  ...
  return (
    <>
      ...
      <Flex className="tec-border" gap={4} mt={1}>
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          <Card
                            height="90px"
                            width={{ base: '100%', md: 'calc(33.33% - 12px)' }}
                            display="flex"
                            alignItems="center"
                            justifyContent="center"
                            border="1px solid #E2E8F0"
